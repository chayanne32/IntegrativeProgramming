...
public final class InputScoresStudent_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        ");
        ...
        String user = "root";
        String pass = "";
        String qry = "SELECT * FROM students WHERE firstname LIKE '%%' "
                + "OR middlename LIKE '%%' OR lastname LIKE '%%'"
                + "OR id_number LIKE '%%'";
        String key = "";
      ...
      out.write("                <a href=\"Login.jsp\"><input type=\"button\" class=\"btn1\" value=\"Logout\"></a>\n");
      out.write("                <fieldset id=\"f2\">\n");
      out.write("                    <h2>Input Scores</h2>\n");
      out.write("                    <table>\n");
      out.write("                        <tr>\n");
      out.write("                            <td><input type=\"text\" id=\"d\" value=\"Student ID or name\" class=\"btn\"></td>\n");
